...
<body>
<div class="main">
<h5 style="color:#FFFFFF;">Thank You <?php echo $_POST["expertFN"] ?></h1>
<?php
...
$firstName=  $_POST["expertFN"];
$lastName=$_POST["expertLN"];
$email=  $_POST["expertEmail"];
$pwd=  $_POST["expertPWD"];
...
$sql = "INSERT INTO expertdetails (First_Name,Last_Name,Email,Expert_Code,pass )
VALUES ('$firstName','$lastName', '$email','$expertcode','$pwd')";
